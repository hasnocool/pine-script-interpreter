...
| --- | ---: | ---: | ---: |
| Completed-trade strategies | 862 | 1,958 | +1,096 |
| No-order strategies | 2,583 | 3,815 | +1,232 |
| Validation errors | 2,569 | 187 | -2,382 |
| Execution-limit stops | 49 | 121 | +72 |
| Wall-clock timeout stops | 18 | 0 | -18 |
| Runtime errors | 0 | 0 | +0 |
| Parse errors | 0 | 0 | +0 |
| Partial snapshots | 67 | 121 | +54 |

Newly completed-trade strategies: **1,112**. 16 strategies that completed trades under 0.3.0 became no-order diagnostics or execution-limit stops under 0.3.1, for a net gain of **1,096** completed-trade strategies.
