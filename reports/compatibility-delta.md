...
| --- | ---: | ---: | ---: |
| Completed-trade strategies | 862 | 1,953 | +1,091 |
| No-order strategies | 2,583 | 3,814 | +1,231 |
| Validation errors | 2,569 | 193 | -2,376 |
...
Newly completed-trade strategies: **1,107**. 16 strategies that completed trades under 0.3.0 became no-order diagnostics or execution-limit stops under 0.3.1, for a net gain of **1,091** completed-trade strategies.
